...
/* harmony import */ var _utils_toggle_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/toggle-menu */ "./js/utils/toggle-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_utils_toggle_menu__WEBPACK_IMPORTED_MODULE_1__["initMenu"])();
    Object(_modules_map_js__WEBPACK_IMPORTED_MODULE_3__["getMap"])();
  });
});
...
var getMap = function getMap() {
  ...
  ymaps.ready(function () {
    ...
    var MyBalloonContentLayoutClass = ymaps.templateLayoutFactory.createClass('<div style="color: #011c40;">$[properties.iconContent]</div>');
...
var navItems = document.querySelectorAll('.main-header__site-item');
